...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('-f',  type=str, help='File to execute')
    ...
    if execute_all:
        ...
        print("Introduce valid arguments:\n -f [file/formula]: input file/formula\n -all: execute all benchmarks\n -v: active traces")