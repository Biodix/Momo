...
def test_closure_build2():
    ...
    closure.build_closure(formula)
    print(closure)
    assert closure == {('|', frozenset({('U', ('G', 'a'), ('X', 'b')), ('R', ('F', 'a'), 'b')})): {'nnf': ('&', frozenset({('R', ('F', '-a'), ('X', '-b')), ('U', ('G', '-a'), '-b')}))},
                       ('&', frozenset({('R', ('F', '-a'), ('X', '-b')), ('U', ('G', '-a'), '-b')})): {'nnf': ('|', frozenset({('U', ('G', 'a'), ('X', 'b')), ('R', ('F', 'a'), 'b')}))},
                       ('U', ('G', 'a'), ('X', 'b')): {'nnf': ('R', ('F', '-a'), ('X', '-b'))},
                       ('R', ('F', '-a'), ('X', '-b')): {'nnf': ('U', ('G', 'a'), ('X', 'b'))},
                       ('X', ('U', ('G', 'a'), ('X', 'b'))): {'nnf': ('X', ('R', ('F', '-a'), ('X', '-b')))},
                       ('X', ('R', ('F', '-a'), ('X', '-b'))): {'nnf': ('X', ('U', ('G', 'a'), ('X', 'b')))},
                       ('G', 'a'): {'nnf': ('F', '-a')},
                       ('F', '-a'): {'nnf': ('G', 'a')},
                       ('X', ('G', 'a')): {'nnf': ('X', ('F', '-a'))},
                       ('X', ('F', '-a')): {'nnf': ('X', ('G', 'a'))},
